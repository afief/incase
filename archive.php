...
<div class="pagiwrapper">
					...
					<?php
						if ( is_day() ) :
							printf( __( 'Daily Archives: %s', 'newbar' ), get_the_date() );

						elseif ( is_month() ) :
							printf( __( 'Monthly Archives: %s', 'newbar' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'newbar' ) ) );

						elseif ( is_year() ) :
							printf( __( 'Yearly Archives: %s', 'newbar' ), get_the_date( _x( 'Y', 'yearly archives date format', 'newbar' ) ) );
